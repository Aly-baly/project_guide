...
import com.example.project_guide.ui.note.NoteFragment;
...
public class TaskAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        final String id = cursor.getString(NoteFragment.COL_TASK_ID);
        final String task = cursor.getString(NoteFragment.COL_TASK_NAME);
